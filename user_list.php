	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_user"><i class="fa fa-plus"></i> Add New Pm</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$gender = array('',"Please Select Gender","Male","Female");
	
                    $Status = array('',"Please Select Status","Active","In-Active");
					...
					<tr>
						...
						<td><b><?php echo $gender[$row['gender']] ?></b></td>
                        <td><b><?php echo $Status[$row['Status']] ?></b></td>
