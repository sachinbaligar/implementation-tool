					...
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select name="gender" id="" class="custom-select custom-select-sm">
								<option value="3" <?php echo isset($gender) && $gender == 3 ? 'selected' : '' ?>>Please Select Gender</option>
								<option value="2" <?php echo isset($gender) && $gender == 2 ? 'selected' : '' ?>>Male</option>
								<option value="1" <?php echo isset($gender) && $gender == 1 ? 'selected' : '' ?>>Female</option>
							</select>
						</div>
						...
						<div class="form-group">
							...
							<select name="Status" id="Status" class="custom-select custom-select-sm">
								<option value="3" <?php echo isset($Status) && $Status == 3 ? 'selected' : '' ?>>Please Select Status</option>
								<option value="2" <?php echo isset($Status) && $Status == 2 ? 'selected' : '' ?>>Active</option>
								<option value="1" <?php echo isset($Status) && $Status == 1 ? 'selected' : '' ?>>In-Active</option>
							</select>
						</div>
						<div class="form-group">
						<label for="" class="control-label">Created (MM/DD/YYYY)</label>
											<input type="text" name="Created" class="form-control multidatepicker"  required  value="<?php echo isset($Created) ? $Created : '' ?>">
